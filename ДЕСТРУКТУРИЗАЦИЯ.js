...
const arr = [45, 34, 65];
const [peremA, peremB, peremC] = arr;
console.log(peremA); // 45
console.log(peremB); // 34
console.log(peremC); // 65
...
// В примере выше свойство width сохраняется в переменную w, свойство height сохраняется в h, а title присваивается одноимённой переменной.
...
// В коде dsit prompt запросит width, но не title.
...
// Если в объекте больше свойств, чем у нас переменных, то мы можем взять необходимые нам, а остальные присвоить куда-нибудь.
